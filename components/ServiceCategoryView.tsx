  ...
  return (
    <main className="flex flex-1 flex-col border-t border-white/10 bg-black/20">
      <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <h1 className="mt-6 flex flex-wrap items-center gap-3 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
        ...
        <p className="mt-8 text-sm text-zinc-500">{t.services.disclaimer}</p>
